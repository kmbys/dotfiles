...
properly disable mozc-mode."
  ...
  (global-set-key (kbd "C-<left>") 'org-promote-subtree)
  (global-set-key (kbd "C-<right>") 'org-demote-subtree)
  (setq org-todo-keywords '((sequence "済")))
  (setq org-todo-keyword-faces 
        '(("済" . (:foreground "blue" :weight bold))))
)
